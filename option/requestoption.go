...
// RequestOption is an option for the requests made by the cadenya API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/cadenya/cadenya-sdk-go#readme-requestoptions
...
func WithEnvironmentStaging() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.cadenya.dev/")
}
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.cadenya.com/")
}
